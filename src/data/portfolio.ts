...
export const profile = {
  ...
  photo: '/src/images/mypicture.jpg',
  resumeUrl: resumePdf,
  available: true,
};
...
export const projects: Project[] = [
  {
    ...
    images: [
      '/src/images/BhssWebMonitoring/image.png',
      '/src/images/BhssWebMonitoring/image copy.png',
      '/src/images/BhssWebMonitoring/image copy 2.png',
      '/src/images/BhssWebMonitoring/image copy 3.png',
      '/src/images/BhssWebMonitoring/image copy 4.png',
      '/src/images/BhssWebMonitoring/image copy 5.png',
      '/src/images/BhssWebMonitoring/image copy 6.png',
      '/src/images/BhssWebMonitoring/image copy 7.png',
      '/src/images/BhssWebMonitoring/image copy 8.png',
    ],
    category: 'fullstack',
    featured: true,
  },
  {
    ...
    images: [
      '/src/images/pgoEventScheduler/1.png',
      '/src/images/pgoEventScheduler/2.png',
      '/src/images/pgoEventScheduler/3.png',
      '/src/images/pgoEventScheduler/4.png',
      '/src/images/pgoEventScheduler/5.png',
      '/src/images/pgoEventScheduler/6.png',
      '/src/images/pgoEventScheduler/7.png',
      '/src/images/pgoEventScheduler/8.png',
      '/src/images/pgoEventScheduler/9.png',
      '/src/images/pgoEventScheduler/10.png',
    ],
    category: 'fullstack',
    featured: true,
  },
  {
    ...
    images: [
      '/src/images/pgoDocumentFileSharing/1.png',
      '/src/images/pgoDocumentFileSharing/2.png',
      '/src/images/pgoDocumentFileSharing/3.png',
      '/src/images/pgoDocumentFileSharing/4.png',
      '/src/images/pgoDocumentFileSharing/5.png',
    ],
    category: 'fullstack',
    featured: true,
  },
  {
    ...
    tech: ['React', 'Firebase', 'Tailwind CSS', 'JavaScript'],
    images: [
      '/src/images/pgoInventorySystem/1.png',
      '/src/images/pgoInventorySystem/2.png',
      '/src/images/pgoInventorySystem/3.png',
      '/src/images/pgoInventorySystem/4.png',
      '/src/images/pgoInventorySystem/5.png',
      '/src/images/pgoInventorySystem/6.png',
      '/src/images/pgoInventorySystem/7.png',
    ],
    category: 'fullstack',
    featured: false,
  },
  {
    ...
    tech: ['React', 'MongoDB', 'TypeScript', 'shadcn/ui', 'Tailwind CSS', 'Express', 'Node.js'],
    images: [
      '/src/images/EventScheduler02/image.png',
      '/src/images/EventScheduler02/image copy.png',
      '/src/images/EventScheduler02/image copy 2.png',
      '/src/images/EventScheduler02/image copy 3.png',
      '/src/images/EventScheduler02/image copy 4.png',
      '/src/images/EventScheduler02/image copy 5.png',
      '/src/images/EventScheduler02/image copy 6.png',
      '/src/images/EventScheduler02/Admin/image.png',
      '/src/images/EventScheduler02/Admin/image copy.png',
      '/src/images/EventScheduler02/Admin/image copy 2.png',
      '/src/images/EventScheduler02/Admin/image copy 3.png',
      '/src/images/EventScheduler02/Admin/image copy 4.png',
    ],
    category: 'fullstack',
    featured: false,
  },
  {
    ...
    tech: ['React', 'Firebase', 'Tailwind CSS', 'JavaScript'],
    images: [
      '/src/images/SalesInventory/1.png',
      '/src/images/SalesInventory/2.png',
      '/src/images/SalesInventory/3.png',
      '/src/images/SalesInventory/4.png',
      '/src/images/SalesInventory/5.png',
      '/src/images/SalesInventory/6.png',
      '/src/images/SalesInventory/7.png',
      '/src/images/SalesInventory/8.png',
      '/src/images/SalesInventory/9.png',
      '/src/images/SalesInventory/10.png',
      '/src/images/SalesInventory/11.png',
    ],
    category: 'fullstack',
    featured: false,
  },
...
export const certifications: Certification[] = [
  {
    ...
    title: 'Cybersecurity',
    date: 'June 20, 2023',
    image: '/src/images/cert1.png',
    badge: '/src/images/badge1.png',
  },
  {
    ...
    badge: '/src/images/badge2.png',
  },
  {
    id: 'cert-it-specialist',
    title: 'IT Specialist in Networking',
    date: 'November 24, 2024',
    image: '/src/images/cert3.png',
    badge: '/src/images/badge3.png',
  },
  {
    id: 'cert-device-config',
    title: 'Device Configuration and Management',
    date: 'December 7, 2024',
    image: '/src/images/cert4.png',
    badge: '/src/images/badge4.png',
  },
];
